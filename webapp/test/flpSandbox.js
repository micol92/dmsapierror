					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SP project1x_1",
									"targetURL": "#project1x1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project1x1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1x1",
									"url": sap.ui.require.toUrl("project1x1")
								}
							}
						}
					}
